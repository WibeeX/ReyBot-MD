...
let prekey = []
let directorio = readdirSync("./WibeBotSession")
...
try {
let listaDirectorios = readdirSync('./ReyBot-MD/');
let SBprekey = []
...
const directories = ['./WibeBotSession/', './ReyBot-MD/']
...
if (reason == 405) {
await fs.unlinkSync("./WibeBotSession/" + "creds.json")
