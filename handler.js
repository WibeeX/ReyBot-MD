...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Wibesinho (https://wa.me/18293733257) */
...
*Intenta Quitar El Baneo Aqui:* wa.me/18293733257
               `.trim();
              m.reply(messageText);
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '⚠️ 𝐖𝐈𝐋𝐁𝐄𝐑𝐓 𝐌𝐃 ⚠️', body: 'Bot de WhatsApp automático', thumbnail: imgAll, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
